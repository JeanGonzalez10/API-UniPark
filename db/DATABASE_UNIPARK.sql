...
CREATE TABLE HISTORICO_LAVADERO(
	id_solicitud FLOAT(5) NOT NULL AUTO_INCREMENT,
	placa_vehiculo varchar(7) NOT NULL,
	fecha_solicitud DATE NOT NULL,
	id_tipo_lavado INT(1) NOT NULL,
...
(1152132122,'SIMON.VANEGAS','4321',"2023-11-09"),
(10251123521,'JEAN.PEREZ','1122',"2023-11-09"),
(10251123523,'ROISON.ANGULO','1133',"2023-11-09"),
(10251123526,'STIVEN.ROLDAN','2211',"2023-11-09");
...
('ABC12A',2,1152132122,"2023-11-09"),
('ABC245',1,10251123523,"2023-11-09");
...
('2023-11-08','ABC12A',11,null,null,"2023-11-09"),
('2023-11-07','ABC245',2,null,null,"2023-11-09");
...
INSERT INTO HISTORICO_LAVADERO (placa_vehiculo,fecha_solicitud,id_tipo_lavado,tarifa,id_empleado, fecha_eliminacion) VALUES
('ABC12A','2023-11-11',1,25000,null,"2023-11-09"),
('TEX001','2023-11-10',2,30000,null,"2023-11-09"),
('ABC245','2023-11-09',3,50000,null,"2023-11-09");
